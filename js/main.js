...
async function createMap() {
  ...
  var apitoken =
    "pk.eyJ1Ijoic3VnYXJhbG1vbmQiLCJhIjoiY2tiaDhsMXg1MDJ4bTMwb2RldXVxaHUwaSJ9.8dECxsXBCSd6x5vbmc8lqA"; //Enter your API Token - go to 'https://www.mapbox.com/install/' to yours */
  var mbUrl =
    "https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={token}";
  var mbStyleUrl =
    "https://api.mapbox.com/styles/v1/{id}/tiles/256/{z}/{x}/{y}?access_token={token}";
...
*/
  ...
  var pointToLayer = function (feature, latlng) {
    ...
    geojsonMarkerOptions.fillColor = lerpColor(
      "#00ffff",
      "ff00ff",
      feature.properties.mag / 10
    );
    return L.circleMarker(latlng, geojsonMarkerOptions).bindTooltip((feature.properties.mag).toString());
  };
